      ...
      <div className="mx-auto max-w-3xl rounded-2xl border border-gray-200 bg-white p-8 shadow-sm">
        ...
        <div className="mt-8 space-y-6 text-sm leading-6 text-gray-700">
          <section>
            ...
            <p className="mt-2">Frontline is an AI-assisted business operations platform for lead handling, review responses, scheduling requests, and customer service workflows. This policy explains how we treat information submitted through the platform.</p>
          </section>

          <section>
            <h2 className="text-lg font-semibold text-gray-900">Information We May Collect</h2>
            <p className="mt-2">We may collect account information, business profile details, customer messages submitted by users, workflow notes, and technical information needed to operate the service.</p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2">Information is used to provide dashboards, generate AI-assisted drafts, organize customer requests, improve workflows, and support customer service or pilot onboarding.</p>
          </section>
